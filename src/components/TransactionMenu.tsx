...
const TransactionMenu = () => {
  ...
  const handleOnDateChange = (e: ChangeEvent<HTMLInputElement>): void => setTransactionFormData({ ...transactionFormData, date: DateTime.fromISO(e.target.value) });
  ...
  return (
    <form className="p-8 bg-white menu-shadow rounded-xl tilt-animation" onSubmit={handleOnSubmit}>
      ...
      <select className="h-8 px-4 bg-gray-200 border border-gray-300 rounded-md" id="categoryId" value={categoryId} onChange={handleOnCategoryChange}>
